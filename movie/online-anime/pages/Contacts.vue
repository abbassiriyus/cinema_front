				...
				<div class="row">
					<div class="col-12">
						<div class="section__wrap">
							<!-- section title -->
							<h1 class="section__title section__title--head">Kontaktlar</h1>
							<!-- end section title -->
		...
		<section class="section">
			<div class="container">
				<div class="row">
						...
						<div class="row">
							<div class="col-12">
								...
								<ul class="contacts__list">
									<li>
										<NuxtLink to="tel:933391634">+998 93 339 1634</NuxtLink>
									</li>
									<li>
										<NuxtLink to="uzdub.group@gmail.com">uzdub.group@gmail.com</NuxtLink>
									</li>
								</ul>

								<ul class="contacts__social">
									<li>
										<a target="_blank" href="https://www.facebook.com/profile.php?id=61555542411738"><svg
									...
									<li>
										<a target="_blank" href="https://www.instagram.com/uzdub.uz/"><svg xmlns="http://www.w3.org/2000/svg"
												viewBox="0 0 24 24">
												<path
									...
									<li>
										<a target="_blank" href="https://t.me/uzdubbing_tarjima_animelar"><svg
												xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
												<path
									...
									<li>
										<a target="_blank" href="https://twitter.com/uzdub_go"><svg xmlns="http://www.w3.org/2000/svg"
												viewBox="0 0 24 24">
												<path
					...
					<div class="col-12 col-lg-6 offset-lg-1 col-xl-7">
						<div class="row">
							<div class="col-12">
								<!-- contact form -->
								<form action="#" class="sign__form sign__form--contacts">
									<div class="row">
										...
										<div class="col-12">
											<div class="sign__group">
												<textarea name="text" id="contact_xabar" class="sign__textarea"
