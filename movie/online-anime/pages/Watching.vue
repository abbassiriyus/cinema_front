                      ...
                      <ul v-for="commnet in data_get.comment"  class="comments__list">
                        <li  class="comments__item" >
                          <div class="comments__autor">
                            <img
                              ...
                              alt=""
                            />
                            <span class="comments__name" v-if="commnet.creators && commnet.creators.name">{{ commnet.creators.name }}    <span v-if="commnet.ptichka"
                            ...
                            <span class="comments__time"
                              >
                             {{commnet.time_create.slice(5,7) }}.{{ commnet.time_create.slice(8,10) }}.{{ commnet.time_create.slice(0,4) }}, {{ commnet.time_create.slice(11,16) }}</span
                            >
                          </div>
                        ...
                        <li v-if="!cinema.quanty"  class="comments__item comments__item--answer">
                          <div class="comments__autor">
                            ...
                            <span class="comments__time"
                              >
                             {{cinema.time_create.slice(5,7) }}.{{ cinema.time_create.slice(8,10) }}.{{ cinema.time_create.slice(0,4) }}, {{ cinema.time_create.slice(11,16) }}</span>
                          </div>
                          <p class="comments__text">
                           {{ cinema.description }}
                          </p>
                        ...
                        <li v-else class="comments__item comments__item--quote">
                          <div class="comments__autor">
                            <img
                              ...
                              alt=""
                            />
                            <span class="comments__name" v-if="cinema.creators && cinema.creators.name">{{ cinema.creators.name }}  
                        ...
                        <li v-for="sharx in data_get.sharx" class="reviews__item">
                          <div class="reviews__autor">
                            ...
                            <span class="reviews__time"
                              > {{sharx.time_create.slice(5,7) }}.{{ sharx.time_create.slice(8,10) }}.{{ sharx.time_create.slice(0,4) }}, 
                              <span v-if="sharx.creators && sharx.creators.name">{{ sharx.creators.name }}</span> tomonidan</span
                            >
