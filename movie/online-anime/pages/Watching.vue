									...
									<div class="row">
										...
										<div class="col-12">
											<div class="comments" v-if="data_get">
												<ul v-for="commnet in data_get.comment" :key="commnet.id"
													...
													<li class="comments__item">
														...
														<div class="comments__actions">
															<div class="comments__rate">
																<button type="button">
																	<svg @click="click_like(true, commnet.id)"
																...
																<button type="button">
																	{{ commnet.min
																	}}<svg @click="click_like(false, commnet.id)"
																		xmlns="http://www.w3.org/2000/svg"
																		viewbox="0 0 24 24">
																		<path
														...
														<li v-if="!cinema.quanty"
															...
															<div class="comments__actions">
																<div class="comments__rate">
																	...
																	<button type="button">
																		{{ cinema.min
																		}}<svg @click="click_like(false, cinema.id)"
																			xmlns="http://www.w3.org/2000/svg"
																			viewbox="0 0 24 24">
																			<path
																				d="M19,2H6.27A3,3,0,0,0,3.32,4.46l-1.27,7A3,3,0,0,0,5,15H9.56L9,16.43A4.13,4.13,0,0,0,12.89,22a1,1,0,0,0,.91-.59L16.65,15H19a3,3,0,0,0,3-3V5A3,3,0,0,0,19,2ZM15,13.79l-2.72,6.12a2.13,2.13,0,0,1-1.38-2.78l.53-1.43A2,2,0,0,0,9.56,13H5a1,1,0,0,1-.77-.36A1,1,0,0,1,4,11.82l1.27-7a1,1,0,0,1,1-.82H15ZM20,12a1,1,0,0,1-1,1H17V4h2a1,1,0,0,1,1,1Z">
												...
												<form action="#" class="sign__form sign__form--comments">
													<div class="sign__group">
														...
														<textarea id="text" name="text" class="sign__textarea"
															placeholder="Fikr yozing" required></textarea>
													</div>
													<button @click="send_message" type="button"
										...
										<div class="col-12">
											<div class="reviews">
												<ul class="reviews__list">
													<li v-for="sharx in data_get.sharx" :key="sharx.id"
														class="reviews__item">
														<div class="reviews__autor">
															...
															<span class="reviews__rating"><svg
																	xmlns="http://www.w3.org/2000/svg"
												...
												<form action="#" class="sign__form sign__form--comments">
													<div class="row">
														<div class="col-12 col-md-6">
															<div class="sign__group">
																<input type="text" class="sign__input"
																	placeholder="Sarlavha" id="sharx_d" required />
															</div>
														</div>
														...
														<div class="col-12">
															<div class="sign__group">
																<textarea id="sharx_m" class="sign__textarea"
																	placeholder="Sharh yozing" required></textarea>
															</div>
														</div>

														<div class="col-12">
															<button @click="clicksharx" type="button"
																class="sign__btn sign__btn--small">
																<span>Yuborish</span>
															</button>
														</div>
						...
						<div class="col-12 col-lg-4">
							<div class="row">
								...
								<div v-for="cinema in top_look" :key="cinema.id" class="col-6 col-sm-4 col-lg-6">
									<div class="item">
										<div @click="handleClick(cinema.id, cinema.looking)"
											class="item__cover item__cover--rate">
