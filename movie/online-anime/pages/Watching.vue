            ...
            <div class="tab-content">
                      ...
                      <ul class="reviews__list">
                        <li class="reviews__item">
                          <div class="reviews__autor">
                            ...
                            <span class="reviews__name"
                              >Best Marvel movie in my opinion</span
                            >
                            <span class="reviews__time"
                              >24.08.2023, Tess Harper tomonidan</span
                            >
                        ...
                        <li class="reviews__item">
                          <div class="reviews__autor">
                            ...
                            <span class="reviews__time"
                              >24.08.2023, Gene Graham tomonidan</span
                            >
                        ...
                        <li class="reviews__item">
                          <div class="reviews__autor">
                            ...
                            />
                            <span class="reviews__name"
                              >It could be better</span
                            >
                            <span class="reviews__time"
                              >24.08.2023, Rosa Lee tomonidan</span
                            >
              ...
              >
                ...
                <div class="gallery" itemscope="">
                  <div class="row row--grid gallery_in" id="lightgallery">
                    <!-- gallery item -->
                    <a
            ...
            <div class="row">
              ...
              <div class="col-6 col-sm-4 col-lg-6">
                <div class="item">
                  ...
                  <div class="item__content">
                    <h3 class="item__title">
                      <NuxtLink to="details1">Red Sky at Night</NuxtLink>
                    </h3>
                    <span class="item__category">
              ...
              <div class="col-6 col-sm-4 col-lg-6">
                <div class="item">
                  ...
                  <div class="item__content">
                    <h3 class="item__title">
                      <NuxtLink to="details1">The Forgotten Road</NuxtLink>
                    </h3>
                    <span class="item__category">
              ...
              <div class="col-6 col-sm-4 col-lg-6">
                <div class="item">
                  ...
                  <div class="item__content">
                    <h3 class="item__title">
                      <NuxtLink to="details1">Dark Horizons</NuxtLink>
                    </h3>
                    <span class="item__category">
                      <NuxtLink to="#">Comedy</NuxtLink>
                      <NuxtLink to="#">Drama</NuxtLink>
              ...
              <div class="col-6 col-sm-4 col-lg-6">
                <div class="item">
                  ...
                  <div class="item__content">
                    <h3 class="item__title">
                      <NuxtLink to="details1">Echoes of Yesterday</NuxtLink>
                    </h3>
                    <span class="item__category">
                      <NuxtLink to="#">Action</NuxtLink>
                      <NuxtLink to="#">Triler</NuxtLink>
              ...
              <div class="col-6 col-sm-4 col-lg-6">
                <div class="item">
                  ...
                  <div class="item__content">
                    <h3 class="item__title">
                      <NuxtLink to="details1">Into the Unknown</NuxtLink>
                    </h3>
                    <span class="item__category">
                      <NuxtLink to="#">Comedy</NuxtLink>
                    </span>
