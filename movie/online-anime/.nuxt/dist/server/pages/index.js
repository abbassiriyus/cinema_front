...
var render = function render() {
  ...
  return _c('div', [!_vm.cinemaData ? _vm._ssrNode("<div class=\"lodaing_page\">", "</div>", [_vm._ssrNode("<div class=\"loading\"><span>Loading</span></div>")], 2) : _vm._ssrNode("<div>", "</div>", [_vm._ssrNode("<section class=\"home\">", "</section>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-12\">", "</div>", [_vm._ssrNode("<div class=\"hero splide splide--hero\">", "</div>", [_vm._ssrNode("<div class=\"splide__arrows\"><button type=\"button\" class=\"splide__arrow splide__arrow--prev\"><svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path d=\"M17,11H9.41l3.3-3.29a1,1,0,1,0-1.42-1.42l-5,5a1,1,0,0,0-.21.33,1,1,0,0,0,0,.76,1,1,0,0,0,.21.33l5,5a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L9.41,13H17a1,1,0,0,0,0-2Z\"></path></svg></button> <button type=\"button\" class=\"splide__arrow splide__arrow--next\"><svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path d=\"M17.92,11.62a1,1,0,0,0-.21-.33l-5-5a1,1,0,0,0-1.42,1.42L14.59,11H7a1,1,0,0,0,0,2h7.59l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l5-5a1,1,0,0,0,.21-.33A1,1,0,0,0,17.92,11.62Z\"></path></svg></button></div> "), _vm._ssrNode("<div class=\"splide__track\">", "</div>", [_vm._ssrNode("<ul class=\"splide__list\">", "</ul>", _vm._l(_vm.carousel2, function (item) {
    ...
    }), 1), _vm._ssrNode(" <div class=\"item__wrap\"><span class=\"item__rate\">" + _vm._ssrEscape(" " + _vm._s(cinema.mark)) + "</span> <ul class=\"item__list\"><li>" + _vm._ssrEscape(_vm._s(cinema.type)) + "</li> <li>" + _vm._ssrEscape(_vm._s(cinema.age_limit) + "+") + "</li></ul></div> <div class=\"item__description\"><p>" + _vm._ssrEscape("\n\t\t\t\t\t\t\t\t\t\t\t\t" + _vm._s(cinema.description) + "\n\t\t\t\t\t\t\t\t\t\t\t") + "</p></div>")], 2)], 2)]);
    ...
    return _vm._ssrNode("<li class=\"splide__slide\">", "</li>", [_vm._ssrNode("<div class=\"item item--carousel\">", "</div>", [item.images.length > 0 ? _c('NuxtLink', {
      staticClass: "item__cover",
      attrs: {
        "to": "watching"
      }
    }, [item.images.length > 0 ? _c('img', {
      staticClass: "item-cover__img very--view__img",
      attrs: {
        "src": item.images[0].image,
        "alt": ""
      }
    }) : _vm._e(), _vm._v(" "), item.payment != 'Free' ? _c('div', {
      staticClass: "d-flex aligin-items-center justify-content-center premium-icon"
    }, [_c('img', {
      staticStyle: {
        "height": "40px"
      },
    ...
    })])])]) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"item__content\">", "</div>", [_vm._ssrNode("<h3 class=\"item__title\">", "</h3>", [_c('NuxtLink', {
      attrs: {
        "to": "watching"
      }
    ...
    }), 1), _vm._ssrNode(" <span class=\"item__rate\">" + _vm._ssrEscape(_vm._s(item.mark)) + "</span>")], 2)], 2)]);
...
// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=7245fed0
