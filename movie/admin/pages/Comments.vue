          ...
          <div class="col-12">
            <div class="main__paginator">
              ...
              <span class="main__paginator-pages"
                >{{ this.izoh.length }} tadan 10 tasi</span
              >
              <!-- end amount -->
          ...
          <div class="modal__content modal__content--view">
            <div class="comments__autor">
              ...
              <span class="comments__time"
                >{{ item.time_create.slice(0, 10) }},
                {{ item.time_create.slice(11, 16) }}</span
              >
            </div>
            <p class="comments__text">{{ item.description }}</p>
            <div class="comments__actions">
...
=======
  ...
  mounted() {
    ...
    try {
      axios
        .get('http://localhost:4002/api/v1/comment')
        .then((res) => {
          axios
            .get('http://localhost:4002/api/v1/cinema')
            .then((res1) => {
              axios
  ...
  methods: {
    ...
    CommentDelete() {
      axios
        .delete(
          `http://localhost:4002/api/v1/comment/${this.deleteId}`
        )
        .then((res) => {
          alert("Ma'lumot o'chirildi")
          window.location.reload()
