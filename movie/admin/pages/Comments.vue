<template>
	<div>
					...
					<div class="col-12">
						<div class="catalog catalog--1">
							<table class="catalog__table">
								...
								<tbody>
									<tr v-for="(item, index) in izoh" ::key="item.id"
		...
		<!-- view modal -->
		<div v-for="item in izohModal" class="modal fade" id="modal-view" tabindex="-1" aria-labelledby="modal-view"
			aria-hidden="true">
					...
					<div class="modal__content">
						<form action="#" class="modal__form">
							...
							<div class="modal__btns">
								<button @click="CommentDelete()" class="modal__btn modal__btn--apply"
