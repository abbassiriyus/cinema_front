  ...
  <div>
    ...
    <div class="sidebar">
      ...
      <ul class="sidebar__nav">
        <li class="sidebar__nav-item">
          <NuxtLink
            ...
            Boshqaruv paneli</NuxtLink
          >
        </li>

        <li class="sidebar__nav-item">
          <NuxtLink to="catalog" class="sidebar__nav-link"
            ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
        ...
        <li class="sidebar__nav-item">
          <NuxtLink to="users" class="sidebar__nav-link"
            ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
                d="M12,2A10,10,0,0,0,4.65,18.76h0a10,10,0,0,0,14.7,0h0A10,10,0,0,0,12,2Zm0,18a8,8,0,0,1-5.55-2.25,6,6,0,0,1,11.1,0A8,8,0,0,1,12,20ZM10,10a2,2,0,1,1,2,2A2,2,0,0,1,10,10Zm8.91,6A8,8,0,0,0,15,12.62a4,4,0,1,0-6,0A8,8,0,0,0,5.09,16,7.92,7.92,0,0,1,4,12a8,8,0,0,1,16,0A7.92,7.92,0,0,1,18.91,16Z"
              />
            </svg>
            FOYDALANUVCHILAR</NuxtLink
          >
        </li>

        <li class="sidebar__nav-item">
          <NuxtLink to="comments" class="sidebar__nav-link"
            ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
        ...
        <li class="sidebar__nav-item">
          <NuxtLink to="reviews" class="sidebar__nav-link"
            ><svg
        ...
        <li class="sidebar__nav-item">
          <NuxtLink
            class="sidebar__nav-link nuxt-link-exact"
            to="#"
            role="button"
      ...
      <div class="sidebar__copyright">
        © DUBGO, 2023—2024. <br /><NuxtLink to="">ASROR SHODIYEV</NuxtLink> tomonidan
        yaratilgan.
      </div>
  ...
  methods: {
    PathActive() {
      setInterval(() => {
        ...
        let lengthPath = routePath.length
        console.log(lengthPath);
        const nuxt_link = document.querySelector('.nuxt-link-exact');
        if (routePath.slice(1, lengthPath) == 'add-item') {
          nuxt_link.classList.add('nuxt-link-exact-active')
        } else {
          nuxt_link.classList.remove('nuxt-link-exact-active')
        }
      }, 500)
